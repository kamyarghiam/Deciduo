...
class Food(object): 
    ...
    def getAlpha(self):
        ...
        t2x = self.happy[0]
        t2y = self.happy[1]
        alpha1 = 1/(self.learn*(h1*t1y + h2*t2y)) #This is a calculated values based on a formula I created
    ...
    def compareUtilityFunction(self):
        ...
        if self.discrete == True:
            ...
            return "For %s, I would have %0.2f (serving %s), and for %s, I would have %0.2f (serving %s)"\
        % (food1, servings1,servingword1, food2, servings2, servingword2)
        """
    ...
    def getValuesFromLambda(self):
        ...
        if self.discrete == True:
            ...
            if len(exerciseList) == 2:
                ...
                % (self.exerciseNames[0],exerciseList[0], self.exerciseNames[1], exerciseList[1])
            elif len(exerciseList) == 3:
                return "You should do %s for %0.2f minutes, %s for %0.2f minutes, and %s for %0.2f minutes" % (self.exerciseNames[0], exerciseList[0], self.exerciseNames[1], exerciseList[1], self.exerciseNames[2], exerciseList[2])
                ...
                % (self.exerciseNames[0],exerciseList[0], self.exerciseNames[1], exerciseList[1], self.exerciseNames[2], exerciseList[2], self.exerciseNames[3], exerciseList[3])
                ...
                % (self.exerciseNames[0], exerciseList[0], self.exerciseNames[1], exerciseList[1], self.exerciseNames[2], exerciseList[2], self.exerciseNames[3], exerciseList[3], self.exerciseNames[4], exerciseList[4]) 
